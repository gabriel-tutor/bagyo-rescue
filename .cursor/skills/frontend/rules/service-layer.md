---
description: Patterns for implementing service layer functions that orchestrate business logic, coordinate multiple data operations, handle dependency injection for testability, and manage complex transformations
