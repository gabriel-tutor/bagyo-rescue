---
description: Patterns for implementing data access functions that fetch from external REST APIs, including fetch operations, error handling, response typing, and test utilities
